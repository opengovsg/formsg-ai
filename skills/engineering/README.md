...
| [`/concise-review`](concise-review/SKILL.md) | Review a PR as one flat list of concise bullet points — no headings, no grouping |
...
/concise-review <pr>             # same target, one flat list of bullets
```
