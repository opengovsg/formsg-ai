...
Claude Code slash-command skills for FormSG. See the [root README](../README.md) for installation instructions.

## General skills (Applicable to all functions)

No per-repo setup required — available immediately after installing the plugin.
